describe('bikesList Controller', () => {

    var $httpBackend, $rootScope, createController;

    // Play bikes data JSON for unit tests
    var mockBikeJSON = {
        "items": [
            {
                "id": 1,
    ...
    beforeEach(inject( $injector => {
        ...
        createController = function () {
            return $controller('bikesList', { '$scope': $rootScope });
        };
